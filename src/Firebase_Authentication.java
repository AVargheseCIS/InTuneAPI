/**Class Firebase_Authentication handles user authentication
 * into the Firebase server content utilizing user email and
 * password.**/
public class Firebase_Authentication {
    /**Email string of this Firebase authentication instance.**/
    private String email;
    /**Password string of this Firebase authentication instance.**/
